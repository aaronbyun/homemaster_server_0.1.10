...
from utils.time_price_info import get_time_price, get_additional_task_time_price, get_additional_tasks_and_prices


class RequestSelectScheduleWebHandler(tornado.web.RequestHandler):
    def post(self):
        ...
        try:
            ...
            booking_info['additional_task_prices'] = get_additional_tasks_and_prices(additional_task, house_type, house_size)
