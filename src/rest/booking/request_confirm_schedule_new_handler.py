...
class RequestConfirmScheduleNewHandler(tornado.web.RequestHandler):
    def post(self):
            ...
            try:
                ...
                mongo_logger.debug('confirm booking', extra = {'new' : 1, 'log_time' : dt.datetime.now(), 'user_id' : uid, 'master_id' : mid, 'booking_id' : booking_ids[0], 'start_time' : start_time_list[0]})
