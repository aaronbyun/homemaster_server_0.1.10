...
class HMScheduler():
    ...
    def get_occupied_slots(self, gu_id, start_date, end_date, prefer_women, have_pet, master_id = '', request_id = ''):
    ...
    def get_available_slots(self, gu_id, geohash, appointment_type, taking_time, prefer_women, have_pet,
        ...
        try:
            ...
            occupied_slots = self.get_occupied_slots(gu_id, cur_date, cur_date + dt.timedelta(days = all_end_date),
        ...
        for master_id in masters:
            ...
            if len(master['occupied_times']) == 2: # free day
                ...
                #while cur_time + dt.timedelta(minutes = taking_time) <= master['free_to']: # add available time list
                    master['available_times'].append(self.time_to_str(cur_time)) # for json serialization
