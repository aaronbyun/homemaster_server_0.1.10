...
class EditBookingForManagerHandler(tornado.web.RequestHandler):
    def post(self):
        ...
        print booking_id, changed, date, additional_task, taking_time, price, start_time_range_begin, start_time_range_end
        ...
        try:
            ...
            print time_changed, task_changed, msg_changed
            print type(time_changed)
                ...
                if success != 'SUCCESS':
                    ...
                    '''if status == BC.BOOKING_PAID: # 미리 지불한 경우는 취소 하고 다시 결제함
                        ...
                        if cancel_ret_code:
                            ...
                            pay_ret_code, pay_msg = request_payment(uid, user_name, booking_id, price, appointment_type)
                            if pay_ret_code:
                                row.tid = pay_msg
