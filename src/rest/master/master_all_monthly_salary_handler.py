...
class MasterAllMonthlySalaryHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        try:
            ...
            for row in result:
                ...
                if prev_master_id == None or master_id != prev_master_id:
                    ...
                    monthly_salary_dict[master_id] = {'name' : master_name,
                                                      'phone' : master_phone,
                                                      'monthly_salary' : monthly_salary,
                                                      'penalty_amount' : penalty_amount}
                else:
                    monthly_salary_dict[master_id]['monthly_salary'] += monthly_salary
            ...
            monthly_salary_dict = OrderedDict(sorted(monthly_salary_dict.items(), key = lambda x : x[0]))
